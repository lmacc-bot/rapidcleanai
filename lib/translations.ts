...
export const translations = {
  en: {
    ...
    proposal_email_stub: "Email sending is coming soon. Copy the text for now.",
  ...
  es: {
    ...
    proposal_email_stub: "El envio por email estara disponible pronto. Por ahora copia el texto.",
